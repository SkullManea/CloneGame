...
public partial class @UI: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""UImap"",
            ""id"": ""4c03fdd6-9c4a-457a-9a9d-e73fbec627eb"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""c5df6244-5ae9-4a8e-a3b6-e02064a6926f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""7a397d75-f804-42e9-9a07-5b4eb0e8300d"",
    ...
    ~@UI()
    {
        UnityEngine.Debug.Assert(!m_UImap.enabled, "This will cause a leak and performance issues, UI.UImap.Disable() has not been called.");
    }
    ...
    public struct UImapActions
    {
        ...
        /// </summary>
        public UImapActions(@UI wrapper) { m_Wrapper = wrapper; }
        /// <summary>
